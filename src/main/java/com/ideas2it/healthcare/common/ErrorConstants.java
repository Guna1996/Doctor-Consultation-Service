...
public class ErrorConstants {
    ...
    public static final String DOCTOR_OR_CLINIC_NOT_FOUND = "Doctor or Clinic not found";
    ...
    public static final String MOBILE_NUMBER_SHOULD_NOT_BE_NULL = "Mobile should not be null";
    ...
    public static final String INPUT_CONTAINS_TEN_NUMBERS_ONLY = "Input contains ten number only";
